...
#
# Exact copy from rules_pkg, with a single change to line 148
# to reference the local build_zip tool.

"""Zip archive creation rule and associated logic."""

load("@rules_pkg//pkg:path.bzl", "compute_data_path", "dest_path")
load(
